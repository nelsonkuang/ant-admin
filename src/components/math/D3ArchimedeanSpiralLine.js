...
class D3ArchimedeanSpiralLine extends React.Component {
    ...
    componentDidMount() {
        ...
        this.archimedeanSpiralLine.width = containerWidth - margin.left - margin.right;
        this.archimedeanSpiralLine.height = this.archimedeanSpiralLine.width;
        this.archimedeanSpiralLine.outerRadius = this.archimedeanSpiralLine.width * 0.5;
        ...
        let y = d3.scaleLinear().range([0, outerRadius]).domain([0, 100]);
    ...
    componentWillReceiveProps(nextProps) {
      if(nextProps.a !== this.props.a || nextProps.b !== this.props.b) { // 更新线条
