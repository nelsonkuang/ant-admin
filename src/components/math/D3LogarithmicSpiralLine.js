...
class D3LogarithmicSpiralLine extends React.Component {
    ...
    componentDidMount() {
        ...
        this.logarithmicSpiralLine.width = containerWidth - margin.left - margin.right;
        this.logarithmicSpiralLine.height = this.logarithmicSpiralLine.width;
        this.logarithmicSpiralLine.outerRadius = this.logarithmicSpiralLine.width * 0.5;
        ...
        let y = d3.scaleLinear().range([0, outerRadius]).domain([0, 10]);
