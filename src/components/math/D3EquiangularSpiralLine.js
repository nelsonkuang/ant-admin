...
class D3EquiangularSpiralLine extends React.Component {
    ...
    componentDidMount() {
        ...
        this.equiangularSpiralLine.width = containerWidth - margin.left - margin.right;
        this.equiangularSpiralLine.height = this.equiangularSpiralLine.width;
        this.equiangularSpiralLine.outerRadius = this.equiangularSpiralLine.width * 0.5;
        ...
        let y = d3.scaleLinear().range([0, outerRadius]).domain([0, 10]);// 定义y轴
    ...
    componentWillReceiveProps(nextProps) {
      if(nextProps.a !== this.props.a || nextProps.k !== this.props.k) { // 更新线条
