...
class D3SinusoidLine extends React.Component {
    ...
    componentDidMount() {
        ...
        let x = d3.scaleLinear().domain([-10, 10]).range([0, width]);
        let y = d3.scaleLinear().domain([10, -10]).range([0, height]);
    ...
    componentWillReceiveProps(nextProps) {
      if(nextProps.a !== this.props.a || nextProps.b !== this.props.b || nextProps.c !== this.props.c || nextProps.d !== this.props.d ) { // 更新线条
        const {width, height, fy} = this.quadraticLine;
