...
class LogarithmicSpiralLine extends React.Component {
    constructor(props) {
        ...
        this.onLogarithmicSpiralLineAChange = this.onLogarithmicSpiralLineAChange.bind(this);
    }
    ...
    onLogarithmicSpiralLineAChange = e => {
      ...
      if(value <= 0 || value === 1){
          ...
          this.setState({
              logarithmicSpiralLine: Object.assign({}, logarithmicSpiralLine, {a: 1 * value})
          });
      }
    }  
                ...
                <Row gutter={10}>
                    <Col className="gutter-row" md={24}>
                        <div className="gutter-box">
                            <Card title={
                              <span>对数函数图像-极坐标，Y=logaX（a>0，且a≠1） 设: a = 
                                <Input placeholder="请输入a的值" style={{width:'20%'}} type='number' onChange={this.onLogarithmicSpiralLineAChange} value={logarithmicSpiralLine.a} />
                              </span>} bordered={false}>
